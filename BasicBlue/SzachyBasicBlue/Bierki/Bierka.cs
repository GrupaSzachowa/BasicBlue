    ...
    public class Bierka : ICloneable
    {
        ...
        public bool przesun(int x, int y, bool pgn)
        {
            ...
            if (this.mozliweRuchy.Contains(new Point(x, y)))
            {
                ...
                //{
                //    MessageBox.Show("Jest szach. Nale¿y ruszyæ siê królem.");
                //    return false;
                //}
                ...
                // funkcja podzielona na dwie, poniewa¿ ta sama funkcja uzywana jest 
                // do symulowania zachowania gracza i do przestawiania bierek przez mechanizm sztucznej inteligencji
                // a gdy algorytm coœ oblicza, to nie chcemy sumowaæ liczby wykonanych ruchów. chcemy 
                // jedynie zmieniaæ wspó³rzêdne bierek
                if (pgn)
                {
        ...
        static public void roszada(Bierka wieza, Bierka krol, Enums.Roszada typRoszady)
        {
            ...
            int pozycjaXWiezy = 0;   // docelowa pozycja wie¿y
            ...
            // pozycje Y siê nie zmieniaj¹.
            wieza.pozycjaX = pozycjaXWiezy;
            krol.pozycjaX = pozycjaXKrola;

            // wygenerowanie mo¿liwych ruchów dla biurerk, które bior¹ udzia³ w roszadzie
        ...
        public bool zbij(Bierka ofiara)
        {
            ...
            if (ofiara != null)
            {
                ...
                {
                    //  if (ofiara.ToString() == "Krol") MessageBox.Show("Nie mo¿na biæ króla");
                    //  else
                    //   {
            ...
            {
                MessageBox.Show("coœ siê popsu³o");
        ...
        public void generujMozliweRuchy(List<Bierka> biale, List<Bierka> czarne)
        {
            ...
            if (this.GetType() == typeof(Krol))    // Krol te¿ zachowuje siê inaczej ni¿ inne piony, dlatego jest traktowany inaczej
            {
                this.mozliweBicia.Clear();
                this.mozliweRuchy.Clear();
                ...
                // sposób na dodanie wiêkszej iloœcio rêcznie stworzonych obiektów w jednej linii
                ...
                foreach (Point p in this.mozliweRuchy)
                {
                    ...
                    if (b != null)
                    {
                        // je¿eli jakaœ bierka zajmuje pole na liœcie ruchów, to musimy usun¹æ ten ruch
                        doUsuniecia.Add(p);
                        // za to je¿eli ma inny kolor, to dodajemy to do biæ.
                        if (b.kolor != this.kolor) this.mozliweBicia.Add(p);
                    }
                }

                // taki zabieg, bo nie mo¿na usuwaæ obiektów z listy w momencie, kiedy po tej liœcie idzie pêtla foreach
                // logiczne, ale potrafi zaskoczyæ :)
        ...
        // funkcja sprawdzaj¹ca, czy ka¿da z bierek ma same dobre ruchy
        // je¿eli lista ruchów którejœ z bierek wychodzi poza obszar szachownicy
        // lub je¿eli na torze ruchu bierki znajduje siê inna bierka, ruch jkest usuwany
        ...
        static public int getPunktacjaListyBierek(List<Bierka> lista, List<Bierka> biale, List<Bierka> czarne)
        {
            ...
            foreach (Bierka b in lista)
            {
                ...
                foreach (Point p in b.mozliweBicia)
                {
                    ...
                    // dodatkowe, w zasadzie oba zbêdne warunki - tak w razie czego :)
        ...
        {
            // funkcja wywo³ywana po wykryciue szacha. Odœwie¿a ona mo¿liwe do poruszania siê pola dla szachowanego króla.
            Krol k;
            List<Point> doUsuniecia = new List<Point>();
